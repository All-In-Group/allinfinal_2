...
function chnageLanguages(x, language) {
  // document.querySelector(".languages-title img").src =
  //   "../img/languages/" + language + ".png";
  var reg = /[a-z]{2}.png/;
  document.querySelector(".languages-title img").src = document
    .querySelector(".languages-title img")
    .src.replace(reg, language);
    ...
    .then((data) => {
      ...
      slide.forEach((el) => {
        ...
        el.getElementsByTagName(
          "button"
        )[0].innerHTML = `<a  href=${slideValue[varSlide].buttonUrl}></a>`;
      ...
      miniServices.forEach((el) => {
        el.getElementsByTagName("h2")[0].innerHTML =
          miniServicesValue[varminiServices].text;
        el.getElementsByTagName("p")[0].innerHTML =
          miniServicesValue[varminiServices].description;
        el.getElementsByTagName(
          "button"
        )[0].innerHTML = `<a  href=${slideValue[varminiServices].buttonUrl}></a>`;
        el.getElementsByTagName("a")[0].innerHTML =
          slideValue[varminiServices].button;
        varminiServices++;
      });
      ...
      miniServicesImg.forEach((el) => {
        el.getElementsByTagName("img")[0].src =
          miniServicesValue[varminiServicesImg].image;
        varminiServicesImg++;
      });
      ...
      aboutUs3DivText.forEach((el) => {
        el.getElementsByTagName("p")[0].innerHTML =
          aboutUsValue[6][varAboutUs3DivText].text;
        varAboutUs3DivText++;
      });

      aboutUs3DivText[2].getElementsByTagName(
        "button"
      )[0].innerHTML = `<a  href=${aboutUsValue[2]}></a>`;
      aboutUs3DivText[2].getElementsByTagName("button")[0].innerHTML =
        aboutUsValue[1];
      ...
      servicesLi.forEach((el) => {
        el.getElementsByTagName("img")[0].src =
          servicesValue[varServices].image;
        el.getElementsByTagName("h3")[0].innerHTML =
          servicesValue[varServices].title;
        varServices++;
      });
      ...
      servicesContent.forEach((el) => {
        el.getElementsByTagName("h4")[0].innerHTML =
          servicesValue[varServicesContent].contentTitle;
        el.getElementsByTagName("div")[0].innerHTML =
          servicesValue[varServicesContent].content;
        varServicesContent++;
      });
      ...
      servicesImg.forEach((el) => {
        el.getElementsByTagName("img")[0].src =
          servicesValue[varServicesImg].contentImage;
        varServicesImg++;
      });
      // TEAM
  ...
  $(".comment_form").on("submit", function (e) {
    ...
    cl_count++;
    $($(".your_comment .com_name p")[cl_count]).text(
      $(".comment_user").val("")
    );
    $($(".your_comment .comment ")[cl_count]).text(
      $(".comment_message").val("")
    );
  });
}

chnageLanguages("arm", "am.png");
